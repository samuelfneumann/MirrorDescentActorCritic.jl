...
const BU = MirrorDescentActorCritic.BraxExperimentUtils
...
function construct_agent(::Type{BatchQAgent}, agent_config, env, seed)
    ...
    policy_update = MirrorDescentActorCritic.get_update(update)
...
function set_actor_update_ratio!(
    agent_config, actor_update::MirrorDescentActorCritic.AbstractActorUpdate,
)
...
function set_critic_update_ratio!(
    agent_config, critic_update::MirrorDescentActorCritic.AbstractCriticUpdate,
)
