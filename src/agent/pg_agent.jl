# TODO: Use the feature_creators. Right now, they are not used.
...
mutable struct PGAgent{
    ...
    function PGAgent(
        ...
        rng = if device isa Lux.LuxCUDADevice
            CUDA.RNG(seed)
        elseif device isa Lux.LuxCPUDevice
...
# TODO: this can use a helper function which dispatches based on the input policy type, then
# we can use this for all agent types
