...
# export AbstractRegulariser, KLRegulariser, EntropyRegulariser
export
...
# TODO: UpdateState should store and automatically increment timestep counter
...
function setup(
    ...
    rng = Random.default_rng()
    Random.seed!(rng, seed)
    return setup(up, π, qf, qf_f, qf_θ, qf_st, optim, rng)
end
...
include("actor/discrete/simplex_dampi.jl")
...
const ClosedFormMirrorDescentUpdate = Union{
    SimplexMDCCEM, SimplexMDRKL, SimplexMDMPO, DualAveragingMPI,
}
